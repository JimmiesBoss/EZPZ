...
function toLeaseRow(d: Record<string, any>) {
  return {
    ...
    utilities_annual: d.utilities_annual ?? null,
    parking_annual: d.parking_annual ?? null,
    property_tax_annual: d.property_tax_annual ?? null,
    insurance_annual: d.insurance_annual ?? null,
    janitorial_annual: d.janitorial_annual ?? null,
    other_annual_costs: d.other_annual_costs ?? null,
    tenant_improvement_cost: d.tenant_improvement_cost ?? null,
    tenant_improvement_allowance: d.tenant_improvement_allowance ?? null,
    furniture_ffe_cost: d.furniture_ffe_cost ?? null,
    construction_buildout_cost: d.construction_buildout_cost ?? null,
    moving_cost: d.moving_cost ?? null,
    other_one_time_costs: d.other_one_time_costs ?? null,
