  ...
  const input: PortfolioInput = {
    ...
    properties: (properties ?? []).map((p) => ({
      ...
      leases: (leasesByProp[p.id] ?? []).map((l) => ({
        ...
        utilitiesAnnual: l.utilities_annual,
        parkingAnnual: l.parking_annual,
        propertyTaxAnnual: l.property_tax_annual,
        insuranceAnnual: l.insurance_annual,
        janitorialAnnual: l.janitorial_annual,
        tenantImprovementCost: l.tenant_improvement_cost,
        tenantImprovementAllowance: l.tenant_improvement_allowance,
        furnitureFfeCost: l.furniture_ffe_cost,
        constructionBuildoutCost: l.construction_buildout_cost,
        movingCost: l.moving_cost,
        otherOneTimeCosts: l.other_one_time_costs,
