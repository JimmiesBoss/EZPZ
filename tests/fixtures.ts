...
export function lease(partial: Partial<LeaseInput> = {}): LeaseInput {
  return {
    ...
    utilitiesAnnual: partial.utilitiesAnnual ?? null,
    parkingAnnual: partial.parkingAnnual ?? null,
    propertyTaxAnnual: partial.propertyTaxAnnual ?? null,
    insuranceAnnual: partial.insuranceAnnual ?? null,
    janitorialAnnual: partial.janitorialAnnual ?? null,
    tenantImprovementCost: partial.tenantImprovementCost ?? null,
    tenantImprovementAllowance: partial.tenantImprovementAllowance ?? null,
    furnitureFfeCost: partial.furnitureFfeCost ?? null,
    constructionBuildoutCost: partial.constructionBuildoutCost ?? null,
    movingCost: partial.movingCost ?? null,
    otherOneTimeCosts: partial.otherOneTimeCosts ?? null,
